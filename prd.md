...
- [ ] **F21** 펀더멘탈 데이터 수집 — DART 재무제표 + Yahoo 재무 + fundamentals DB
- [ ] **F22** 퀀트 스코어링 고도화 — 6팩터 복합 점수 (밸류/퀄리티/성장/타이밍/촉매/매크로)
- [ ] **F23** 수급 데이터 수집 — KRX 외국인/기관 순매수 + Fear & Greed Index
- [ ] **F24** 마커스 에이전트 설정 — 시니어 펀드매니저 전문 에이전트
- [ ] **F25** 성과 추적 + 가중치 학습 — outcome 자동 기록, 월간 성적표, 팩터별 적중률
